...
namespace User.Api.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(IUnitOfWork uof, IBcryptCryptography cryptography, 
            ...
            ILogger<UsersController> logger, IBus bus, SqidsEncoder<long> sqids)
        {
            _uof = uof;
            _bus = bus;
            _sqids = sqids;
