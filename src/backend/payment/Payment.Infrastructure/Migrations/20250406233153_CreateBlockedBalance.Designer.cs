...
namespace Payment.Infrastructure.Migrations
{
    ...
    [Migration("20250406233153_CreateBlockedBalance")]
    partial class CreateBlockedBalance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payment.Domain.Entities.BlockedBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Payment.Domain.Entities.BlockedBalance", b =>
                {
                    b.HasOne("Payment.Domain.Entities.Balance", "Balance")
                        .WithMany()
